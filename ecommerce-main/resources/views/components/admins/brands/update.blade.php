...
<div class="modal fade" id="updateModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <form id="update_form">
            ...
            <div class="modal-body">
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="text" id="nameUpdate" class="form-control" placeholder="Brand Name">
                </div>
  ...
  <script>
    ...
    async function FillUpdateForm(id) {
        ...
        let res = await axios.post('/brand-byId',{id:id})
    ...
    async function Update() {
        ...
        if (!nameUpdate) {
            ...
            let res = await axios.post('/brand-update',updateFormData)
            if (res.status === 200) {
                await getList()
